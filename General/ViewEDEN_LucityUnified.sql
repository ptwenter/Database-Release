...
GO
GRANT SELECT ON dbo.EDEN_CUSTOMER TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_PROJNO TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_INVENTORY TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_ACCTNO TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_PARCADDCUST TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_PARCADDMETER TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_PARCADDOWN TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.eslparcr TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esusvlor TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esuservd TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esuacctr TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esucustj TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esqcustr TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esladdrj TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.esladdrr TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.eslstrtr TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.ESQCMODD TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.ESLOWNRR TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_ACTIVECUST TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_ACTIVECUSTOWN TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_PARCADDCUSTOWN TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_WAREHOUSE TO GBAGROUP AS dbo
...
FROM   WTMETER
GO
GRANT SELECT ON dbo.EDEN_MLOCLOOKUPD TO GBAGROUP AS dbo
...
GO
GRANT SELECT ON dbo.EDEN_WKMETER TO GBAGROUP AS dbo
