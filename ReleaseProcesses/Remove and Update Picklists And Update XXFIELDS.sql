...
DELETE FROM LucityDEV..CMFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..CMFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..ELFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..ELFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..EFFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..EFFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..PKFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..PKFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..SWFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..SWFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..SMFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..SMFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..STFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..STFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..WTFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..WTFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
...
DELETE FROM LucityDEV..WKFIELDSDESCTXT WHERE ID NOT IN (SELECT ID FROM LucityDEV..WKFIELDS) OR DESCRIPTION LIKE '%nunit%' OR CODE LIKE '%nunit%' OR DESCRIPTION LIKE 'qq%' OR DESCRIPTION LIKE 'qa%' OR CODE LIKE 'qq%' OR CODE LIKE 'qa%'
